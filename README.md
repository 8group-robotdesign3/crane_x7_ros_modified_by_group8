...
CRANE-X7のROSパッケージです。このパッケージはオリジナルである [https://github.com/rt-net/crane_x7_ros]　に対して千葉工業大学未来ロボティクス学科の講義内グループ8班が変更を加えたものです。主に各フォルダのpackage.xmlファイル, crane_x7_examplesフォルダ, crane_x7_gazeboフォルダ,crane_x7_descriptionフォルダの内容に変更を加えています。
